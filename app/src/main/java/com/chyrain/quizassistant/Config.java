...
public class Config {
    ...
    public static final String DOWNLOAD_LINK = URL_HOST + "app/wxbot/V5WxBot.apk";
    public static final String UPDATE_LINK = URL_HOST + "app/wxbot/version.xml";
    public static final String INTRO_LINK = URL_HOST + "app/wxbot/intro.html";
