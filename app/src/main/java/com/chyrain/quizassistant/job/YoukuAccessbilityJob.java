 ...
 */
public class YoukuAccessbilityJob extends DatiAccessbilityJob {

    private static final String TAG = "YoukuAccessbilityJob";

    /** 监听应用的包名(需添加到——service_config.xml) */
    private static final String THE_PACKAGENAME = "com.youku.phone";
    private static final String THE_JOBKEY = "yk";

    /** 红包消息的关键字*/
    private static final String APP_NAME = "疯狂夺金";
    ...
    public boolean isEnable() {
        return getConfig().isEnableWechat() && getConfig().isEnableYK();
    }
    ...
    public void onReceiveJob(AccessibilityEvent event) {
         ...
         */
            ...
            if (event.getClassName().equals("com.youku.ui.activity.HomePageActivity")) {
                ...
                if (getConfig().isEnableAutoTrust()) {
                    ...
                    mHandler.postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            clickAtChildNodeWithId("dynamic_container");
                        }
                    }, 2000);
                }
            } else if (event.getClassName().equals("com.youku.livesdk.LiveWeexActivity")) {
                mLastWindow = mCurrentWindow;
