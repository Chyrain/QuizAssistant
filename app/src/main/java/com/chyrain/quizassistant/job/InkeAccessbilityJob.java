...
/**
 * 映客直播AccessibilityEvent和通知事件接收处理
 * @author Chyrain
 ...
 */
public class InkeAccessbilityJob extends DatiAccessbilityJob {

    private static final String TAG = "InkeAccessbilityJob";

    /** 监听应用的包名(需添加到——service_config.xml) */
    private static final String THE_PACKAGENAME = "com.meelive.ingkee";
...
//            }
        ...
        if(eventType == AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED) { /* 窗口切换 activity类名：event.getClassName() */
            ...
            if (event.getClassName().equals("com.meelive.ingkee.business.main.ui.MainActivity")) {
