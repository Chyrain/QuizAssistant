...
/**
 * 淘宝《点题成金》AccessibilityEvent和通知事件接收处理
 * @author Chyrain
 ...
 */
public class TaobaoAccessbilityJob extends DatiAccessbilityJob {

    private static final String TAG = "TaobaoAccessbilityJob";

    /** 监听应用的包名(需添加到——service_config.xml) */
    private static final String THE_PACKAGENAME = "com.taobao.taobao";
    private static final String THE_JOBKEY = "tb";

    /** 红包消息的关键字*/
    private static final String APP_NAME = "点题成金";
    ...
    public boolean isEnable() {
        return getConfig().isEnableWechat() && getConfig().isEnableTB();
    }
    ...
    public void onReceiveJob(AccessibilityEvent event) {
         ...
         */
            ...
            if (event.getClassName().equals("com.taobao.tao.homepage.MainActivity3")) {
            ...
            } else if (event.getClassName().equals("com.taobao.weex.WXActivity")) { //com.taobao.browser.BrowserActivity
                mLastWindow = mCurrentWindow;
            ...
            } else if (event.getClassName().equals("com.taobao.taolive.TaoLiveMillionActivity")) {
                mLastWindow = mCurrentWindow;
