...
/**
 * 芝士超人AccessibilityEvent和通知事件接收处理
 * @author Chyrain
 ...
 */
public class ZhishiAccessbilityJob extends DatiAccessbilityJob {

    private static final String TAG = "ZhishiAccessbilityJob";

    /** 监听应用的包名(需添加到——service_config.xml) */
    private static final String THE_PACKAGENAME = "com.inke.trivia";
